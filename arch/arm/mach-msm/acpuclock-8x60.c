...
#define L_VAL_SCPLL_CAL_MAX	0x13 /* = 1728 MHz with 27MHz source */
...
/*{ {0, 0},  MAX_AXI, ACPU_AFAB,  1, 0, 0, 0,    L2(0),   825000, 0x03006000},
  ...
  { {1, 1},  192000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   650000, 0x03006000},
  /* MAX_AXI row is used to source CPU cores and L2 from the AFAB clock. */
  { {0, 0},  MAX_AXI, ACPU_AFAB,  1, 0, 0, 0,    L2(0),   650000, 0x03006000},
  { {1, 1},  384000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   650000, 0x03006000},
  { {1, 1},  432000,  ACPU_SCPLL, 0, 0, 1, 0x08, L2(2),   700000, 0x03006000},
  { {1, 1},  540000,  ACPU_SCPLL, 0, 0, 1, 0x09, L2(3),   750000, 0x03006000},
  { {1, 1},  702000,  ACPU_SCPLL, 0, 0, 1, 0x0A, L2(4),   800000, 0x03006000},
  { {1, 1},  810000,  ACPU_SCPLL, 0, 0, 1, 0x0B, L2(5),   850000, 0x03006000},
  { {1, 1},  918000,  ACPU_SCPLL, 0, 0, 1, 0x0C, L2(6),   900000, 0x03006000},
  { {1, 1}, 1026000,  ACPU_SCPLL, 0, 0, 1, 0x0D, L2(7),   950000, 0x03006000},
  { {1, 1}, 1134000,  ACPU_SCPLL, 0, 0, 1, 0x0E, L2(8),  1000000, 0x03006000},
  { {1, 1}, 1296000,  ACPU_SCPLL, 0, 0, 1, 0x0F, L2(9),  1050000, 0x03006000},
  { {1, 1}, 1404000,  ACPU_SCPLL, 0, 0, 1, 0x10, L2(10), 1100000, 0x03006000},
  { {1, 1}, 1512000,  ACPU_SCPLL, 0, 0, 1, 0x11, L2(11), 1125000, 0x03006000},
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x12, L2(12), 1175000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x13, L2(13), 1225000, 0x03006000},
  { {0, 0}, 0 },
};
